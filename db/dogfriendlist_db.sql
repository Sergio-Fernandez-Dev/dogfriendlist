...
ALTER TABLE `Coordinates`
  ADD PRIMARY KEY `FK_COORDINATES_SPOTS` (`SpotId`),
  MODIFY `SpotId` INT(8) NOT NULL ;
...
ALTER TABLE `Coordinates`
  ADD CONSTRAINT `FK_COORDINATES_SPOTS` FOREIGN KEY (`SpotId`) 
