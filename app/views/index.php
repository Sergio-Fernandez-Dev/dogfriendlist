<div class="box">
    <div class="form--finder-style form--850 form--615"  id="finder-form">
        <input class="form__field form__field--finder-style form__field--850 form__field--615{" id="address" name="address"
        type="text" placeholder="Buscando ubicación" onkeydown="checkEnterIsPressed(event, 'index')">
        <select class="form__select form__select--finder-style form__select--850 form__select--615" id="finder-category" name="category" placeholder="Todos los spots">
        ...
        <input class="button button--615" id="finder-button" type="button" value="Buscar" onclick="prepareFinderQuery(true)">
    </div>
