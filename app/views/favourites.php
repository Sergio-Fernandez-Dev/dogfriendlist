<div class="box">
    <div class="form form--finder-style form--850 form--635" id="finder-form">
        <input class="form__field form__field--finder-style form__field--850 form__field--635{" id="fav-address" name="fav-address"
        type="text" placeholder="Buscar por localización" onkeydown="checkEnterIsPressed(event, 'favs')">
        <select class="form__select form__select--finder-style form__select--850 form__select--635" id="fav-category" name="fav-category" onchange="hideMarkers()">
        ...
        <input class="button button--635" id="finder-button" type="button" value="Buscar" onclick="findFavsFromAddres()">
    </div>
