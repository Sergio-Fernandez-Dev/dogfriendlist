...
<form class="form" id="new-spot-form" method="POST" onkeydown="return event.key != 'Enter';">
    <div class="form--finder-style form form--615">
        <input class="form__field form__field--finder-style form__field--615" type="text" name="title" placeholder="Título" required><br>
            <select class="form__select form__select--615" name="category">
    ...
    <div class="form form--finder-style form--615">
        <input class="form__field form__field--finder-style form__field--850 form__field--615" id="new-spot-finder-form" type="text" name="address" 
        placeholder="Dirección (opcional)" onkeydown="checkEnterIsPressed(event, 'new-spot')"><br>
        <input class="button button--25rem button--850 button--615 " id="finder-button" type="button" value="Buscar" onclick="findNewSpot()">
    </div>
